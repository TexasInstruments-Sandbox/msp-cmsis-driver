...
#define DRIVER_SPI0_TRANSMIT_DMA_HW         (DRIVER_DMA_HW_NONE)
#define DRIVER_SPI0_TRANSMIT_DMA_CH         (DRIVER_DMA_CH_NONE)
#define DRIVER_SPI0_TRANSMIT_DMA_TRIG       (DRIVER_DMA_TRIG_NONE)
#define DRIVER_SPI0_RECEIVE_DMA_HW          (DRIVER_DMA_HW_NONE)
#define DRIVER_SPI0_RECEIVE_DMA_CH          (DRIVER_DMA_CH_NONE)
#define DRIVER_SPI0_RECEIVE_DMA_TRIG        (DRIVER_DMA_TRIG_NONE)
#endif
